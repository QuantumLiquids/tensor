...
*
* Description: GraceQ/tensor project. `U(1) \cross U(1) \cross Zn` QN class, with dynamic value of n
*/


#ifndef GQTEN_GQTENSOR_SPECIAL_QN_U1U1ZQN_H
#define GQTEN_GQTENSOR_SPECIAL_QN_U1U1ZQN_H
...
#endif //GQTEN_GQTENSOR_SPECIAL_QN_U1U1ZQN_H
