...
*
* Description: GraceQ/tensor project. U(1) QN class.
*/

/**
@file u1qn.h
@brief U(1) QN class = gqten::QN<gqten::U1QNVal>.
 Avoiding virtual function realization. (except Show)
 Compatible in reading and writing  QN<U1QNVal> data.
*/

#ifndef GQTEN_GQTENSOR_SPECIAL_QN_U1QN_H
#define GQTEN_GQTENSOR_SPECIAL_QN_U1QN_H
...
#endif //GQTEN_GQTENSOR_SPECIAL_QN_U1QN_H
