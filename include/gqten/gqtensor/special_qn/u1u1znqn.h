...
* Creation Date: 20201-9-29
*
* Description: GraceQ/tensor project. `U(1) \cross U(1) \cross Zn` QN class.
*/

/**
@file u1u1znqn.h
@brief `U(1) \cross U(1) \cross Zn` QN class = gqten::QN<U1QNVal, U1QNVal, ZnQNVal>.
 Avoiding virtual function realization. (except Showable).
*/

#ifndef GQTEN_GQTENSOR_SPECIAL_QN_U1U1ZNQN_H
#define GQTEN_GQTENSOR_SPECIAL_QN_U1U1ZNQN_H
...
#endif //GQTEN_GQTENSOR_SPECIAL_QN_U1U1ZNQN_H
